...
class SigmoidLayer(Layer):
    ...
    def backward(self, grad_z):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        return self.sigmoid_fn(self._cache_current) * (1 - self.sigmoid_fn(self._cache_current)) * grad_z
        #######################################################################
        #                       ** END OF YOUR CODE **
        #######################################################################
...
            - neurons {list} -- Number of neurons in each linear layer
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        self.layer_dicts = {'relu': ReluLayer,
        ...
        for i in range(len(neurons)):
            self._layers.append(LinearLayer(current_dim, neurons[i]))
            current_dim = neurons[i]
            self._layers.append(self.layer_dicts[activations[i]]())
        #######################################################################
        #                       ** END OF YOUR CODE **
        #######################################################################
...
class Trainer(object):
    ...
    def __init__(
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        self.loss_dict = {'cross_entropy': CrossEntropyLossLayer,
                          'mse': MSELossLayer}
        self._loss_layer = self.loss_dict[loss_fun]()
        #######################################################################
        #                       ** END OF YOUR CODE **
        #######################################################################
    ...
    def shuffle(input_dataset, target_dataset):
        ...
        #                       ** START OF YOUR CODE **
        #######################################################################
        s = np.arange(len(input_dataset))
        np.random.shuffle(s)
        return input_dataset[s], target_dataset[s]
    ...
    def train(self, input_dataset, target_dataset):
        ...
        while c < len(input_dataset):
            inp = input_dataset[c:c + self.batch_size]
            x.append(inp)
            y.append(target_dataset[c:c + self.batch_size])
            c += self.batch_size
        for _ in range(self.nb_epoch):
            for n in range(len(x)):

                y_pred = self.network.forward(x[n])
                loss = self._loss_layer.forward(y_pred, y[n])
...
class Preprocessor(object):
    ...
    def __init__(self, data, scale=[0, 1]):
        """
